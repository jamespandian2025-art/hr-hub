                          ...
                          <div className="reports-row-actions">
                            ...
                            {activeReportMenu === report.name && (
                              <div className="reports-row-menu" role="menu">
                                <button type="button" role="menuitem" onClick={() => setActiveReportMenu('')}>Open report</button>
                                <button type="button" role="menuitem" onClick={() => setActiveReportMenu('')}>Download {report.format}</button>
                                <button type="button" role="menuitem" onClick={() => setActiveReportMenu('')}>Schedule report</button>
                              </div>
                            )}
                          </div>
                        </td>
...
.reports-row-menu { position: absolute; top: calc(100% + 6px); right: 0; z-index: 25; width: 168px; border: 1px solid #e8edf4; border-radius: 8px; background: #fff; box-shadow: 0 18px 44px rgba(15,23,42,.16); padding: 6px; display: grid; gap: 2px; }
