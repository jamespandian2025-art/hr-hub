...
const statSubStyle = { display: 'block', marginTop: 6, color: '#64748b', fontSize: 12 } as const
...
const emptyLineStyle = { minHeight: 62, display: 'grid', placeItems: 'center', color: '#64748b', fontSize: 13, textAlign: 'center' as const } as const
